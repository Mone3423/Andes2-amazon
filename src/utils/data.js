// destinos img
import tour4 from "../assets/images/tour/LaPaz.jpg";
import tour5 from "../assets/images/tour/Cochabamba.jpg";
...
import image9 from "../assets/images/new/9.jpg";
import image10 from "../assets/images/new/10.jpg";
import image11 from "../assets/images/new/11.jpg";
...
export const popularsData = [
  ...
  {
    id: 7,
    title: "Discover Bolivia's Hidden Treasures: 7-Day Adventure Through Salt Flats & Silver Mines",
    image: tour8,  // Cambia el nombre de la imagen según lo que tengas
    location: "Bolivia, La Paz-Potosí-Chuquisaca-Atacama",
  ...
  {
    id: 2,
    title: "A Culinary and Cultural Walking Full Day Tour",
    image: tour4,  // Cambia el nombre de la imagen según lo que tengas
  ...
  {
    id: 8,
    title: "Lake Titicaca Tour",
    image: tour11,  // Cambia el nombre de la imagen según lo que tengas
  ...
  {
    id: 11,
    title: "Lake Titicaca Tour: 2 Days of Adventure and Culture",
    image: tour11,  // Cambia el nombre de la imagen según lo que tengas
    location: "Bolivia, La Paz, Copacabana",
    category: ["Adventure", "Cultural"],
    days: "2 days - 1 night",
  ...
  {
    id: 10,
    title: "Lake Titicaca Tour: Full Day",
    image: tour11,  // Cambia el nombre de la imagen según lo que tengas
    location: "Bolivia, La Paz, Copacabana",
    category: ["Adventure", "Cultural"],
    days: "1 day",
  ...
  {
    id: 4,
    title: "One-Day Uyuni Salt Flats Tour",
    image: tour8,  // Cambia el nombre de la imagen según lo que tengas
    location: "Bolivia, Potosí, Salar de Uyuni",
    category: ["Adventure", "Nature"],
    days: "1 day",
  ...
  {
    id: 5,
    title: "Uyuni Salt Flats Tour: Where You Reach the Sky Express",
    image: tour8,  // Cambia el nombre de la imagen según lo que tengas
    location: "Bolivia, Potosí, Salar de Uyuni",
    category: ["Adventure", "Nature"],
    days: "3 days",
  ...
  },
  {
    ...
    category: ["Colonial Architecture", "Local Tour"],
...
export const tourDetailsData = [
  {
    ...
    highlights: [
      " •	Visit beautiful Bolivian cities with colonial architecture",
      "•	Travel to the Uyuni Salt Flats through surreal deserts",
      "•	Explore marketplaces and get in touch with the locals",
      "See Bolivia's main highlights on this amazing 12-day adventure that will leave you awesome memories. Discover La Paz on a city tour, take funny pictures at the famous Uyuni Salt Flats, awe at moon-like landscapes, visit traditional cities like Potosi and Sucre, and learn about the Bolivian way of life.",

    ],

    itinerary: [
      {
        title: `<span class="me-1 fw-bold">Day 1:</span> Arrival in La Paz`,
        des: `Welcome to Bolivia! Upon arrival at La Paz Airport, you will be transferred to your accommodation at the Adventure Brew Hostel. Settle in and get ready for your Bolivian adventure.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 2:</span> Explore La Paz`,
        des: `Dive into the heart of La Paz with the La Paz Local City Encounter. Your local guide will take you through the city's highlights, starting at Plaza Murillo. Discover the rich history and culture as you visit San Pedro Prison, explore vibrant local markets, and ride the cable car for stunning views of the city. Return to Adventure Brew Hostel for a restful night.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 3:</span> Travel to Uyuni`,
        des: `Embark on an overnight bus journey from La Paz to Uyuni. Experience the scenic landscapes as you travel through Bolivia's diverse terrain.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 4:</span> Uyuni Salt Flats Adventure Begins`,
        des: `Begin your Uyuni Salt Flats & Desert Adventure. Visit the train graveyard and Colchani before venturing onto the vast Uyuni Salt Flats. Capture unique photos at Isla Incahuasi and enjoy a breathtaking sunset. Spend the night in a salt hotel in Villa Candelaria.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 5:</span> Explore Eduardo Avaroa National Reserve`,
        des: `Continue your adventure through the Chiguana Desert and visit stunning Andean lagoons inhabited by flamingos. Explore the Eduardo Avaroa National Reserve and marvel at the Red Lagoon. Overnight in a shared family lodge.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 6:</span> Return to Uyuni`,
        des: `Start early with a visit to Sol de Mañana Geyser, then relax in natural hot springs. Journey through the Dali Desert and Green Lagoon before returning to Uyuni by evening. Check-in at Piedra Blanca Hostel.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 7:</span> Journey to Potosi`,
        des: `Travel from Uyuni to Potosi, where you'll check into Hostal El Turista. Take some time to explore this historic city known for its rich mining history.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 8:</span> Travel to Sucre`,
        des: `Transfer from Potosi to Sucre and check into Kultur Berlin. Enjoy an evening exploring Sucre's charming streets and colonial architecture.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 9:</span> Discover Sucre`,
        des: `Join the Sucre with a Local tour and learn about the city's history and traditions. Visit Plaza 25 de Mayo, enjoy a traditional breakfast, explore Bolivar Park, and take in panoramic views from La Recoleta.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 10:</span> Free Day in Sucre`,
        des: `Enjoy a day at leisure in Sucre. Explore on your own or opt for additional experiences such as visiting local museums or taking a cooking class.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 11:</span> Return to La Paz`,
        des: `Travel overnight from Sucre back to La Paz, preparing for your final day in Bolivia.`,
      },
      {
        title: `<span class="me-1 fw-bold">Day 12:</span> Departure from La Paz`,
        des: `Conclude your Bolivian adventure with a transfer from your accommodation to La Paz Airport for your departure flight. This itinerary offers an immersive experience of Bolivia’s rich cultural heritage and breathtaking natural landscapes, ensuring unforgettable memories of this vibrant country.`,
      },
    ],

    included: [
      "Accommodation in 2 La Paz Junior Suites (Adventure Brew Hostel)",
      "Accommodation in 2 Sucre Junior Suites (Kultur Berlin Hotel)",
      "Accommodation in 1 Potosí Double Room (Hostal El Turista)",
      "Accommodation in 1 Uyuni Junior Suite (Salt Hotel)",
      "Shared accommodation at Piedra Blanca Hostel and Eduardo Avaroa National Reserve Lodge",
      "Transportation includes airport transfers in La Paz, overnight buses, and intercity transfers between Sucre, Potosí, and Uyuni",
      "Meals include 9 breakfasts, 3 lunches, and 2 dinners as per itinerary",
      "Professional English-speaking guide for city exploration in La Paz, Sucre, and Uyuni",
      "Guided 3D/2N Uyuni Salt Flats & Desert Adventure, including all entry fees",
      "City highlights tours with local guides in La Paz and Sucre",
      "Flexible, customizable trip with pre-arranged accommodations and transport to match your needs",
    ...
    faqs: [
      {
        "question": "What is the duration of the Bolivia Highlights Tour?",
        "answer": "The tour lasts for 12 days and 11 nights, starting and ending in La Paz, Bolivia."
      },
      {
        "question": "What type of accommodation is provided?",
        "answer": "The tour includes a mix of accommodations: junior suites in Sucre and La Paz, a double room in Potosi, and unique stays such as a salt hotel in Uyuni."
      },
      {
        "question": "Are meals included in the tour package?",
        "answer": "Yes, the package includes 9 breakfasts, 3 lunches, and 2 dinners."
      },
      {
        "question": "What are the main highlights of this tour?",
        "answer": "The tour covers key attractions such as the Uyuni Salt Flats, Eduardo Avaroa National Reserve, and cultural experiences in cities like La Paz, Potosi, and Sucre."
      },
      {
        "question": "What activities are included in the Uyuni Salt Flats & Desert Adventure?",
        "answer": "This adventure includes visits to the train graveyard, Colchani, Isla Incahuasi, and Pia Pia Island. You will also explore the Chiguana Desert and see Andean lagoons with flamingos."
      },
      {
        "question": "What can I expect from the 'Sucre with a Local' experience?",
        "answer": "This walking tour offers insights into Sucre's history and traditions. You'll visit Plaza 25 de Mayo, local markets for a traditional breakfast, Bolivar Park, and La Recoleta viewpoint."
      },
      {
        "question": "How will I travel between locations?",
        "answer": "The tour includes various transfers such as overnight buses from La Paz to Uyuni and from Sucre to La Paz. Local transportation is also used for city tours."
      },
      {
        "question": "Is airport transfer included?",
        "answer": "Yes, airport transfers are included at the beginning and end of the tour in La Paz."
      },
      {
        "question": "Are there any optional activities available?",
        "answer": "Optional activities are available but not included in the package price. Prices for these activities can change without notice."
      },
      {
        "question": "What is not included in the tour package?",
        "answer": "The package does not include travel insurance, tips, personal expenses, or meals not mentioned in the itinerary."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        title: `<span class="me-1 fw-bold">9:00 AM:</span> Historical Exploration at Plaza Murillo`,
        des: `Begin your La Paz city tour at the iconic stone book statue in Plaza Murillo. Dive into Bolivia's history as you explore the main square and learn about the significance of the surrounding buildings.`
      },
      {
        title: `<span class="me-1 fw-bold">10:00 AM:</span> Traditional Bolivian Breakfast`,
        des: `Visit a local café to enjoy aromatic Bolivian coffee paired with a savory Salteña. Discover why these flavors are staples in Bolivian cuisine.`
      },
      {
        title: `<span class="me-1 fw-bold">11:00 AM:</span> San Pedro Prison and Local Markets`,
        des: `Walk to the infamous San Pedro Prison and hear captivating stories about this unique landmark. Then, immerse yourself in the vibrant colors, sounds, and scents of local markets like Mercado Rodriguez, known for its fresh produce and traditional foods.`
      },
      {
        title: `<span class="me-1 fw-bold">12:30 PM:</span> Journey to Southern La Paz`,
        des: `Experience local life as you travel to the southern part of the city using local transportation. This area is known for its affluence and safety, offering a different perspective of La Paz.`
      },
      {
        title: `<span class="me-1 fw-bold">1:00 PM:</span> Authentic Bolivian Lunch`,
        des: `Savor traditional dishes at a local restaurant, learning about the ingredients and cooking methods that define Bolivian cuisine. Consider including popular dishes such as Lake Titicaca fish or anticuchos.`
      },
      {
        title: `<span class="me-1 fw-bold">2:30 PM:</span> Cable Car Adventure`,
        des: `Ride the Green, Yellow, and Silver cable cars for breathtaking panoramic views of La Paz and El Alto. The cable car system offers a unique perspective of the city and is a must-do activity.`
      },
      {
        title: `<span class="me-1 fw-bold">3:30 PM:</span> Explore El Alto Witch Market`,
        des: `Discover mystical items at the Witch Market in El Alto, learning about Bolivian folklore and traditions. Shop for unique souvenirs to remember your La Paz city tour.`
      },
      {
        title: `<span class="me-1 fw-bold">4:30 PM:</span> Return to La Paz Center`,
        des: `Descend back to the city center via cable car while enjoying more stunning views.`
      },
      {
        title: `<span class="me-1 fw-bold">5:00 PM:</span> Central Witch Market and Shopping Streets`,
        des: `Visit the central Witch Market of La Paz and compare it with El Alto's market. Stroll through popular shopping streets, observing daily life in La Paz.`
      },
      {
        title: `<span class="me-1 fw-bold">6:00 PM:</span> Conclude with Traditional Bolivian Soup`,
        des: `End your culinary journey with a warming bowl of black potato or peanut soup, reflecting on your day of adventures.`
      }
    ],
    included: [
    ...
    additionalInformation: {
      "description": "This immersive 7-hour La Paz city tour promises to awaken your senses and leave you with unforgettable memories. Book now for a day filled with discovery, flavor, and wonder in Bolivia's captivating capital!",
      "note": "Please make sure you do not book night buses or anything at night since the tour may finish late.",
  ...
  },
  {
    ...
    included: [
      ...
      "1 night in a salt hostel, 1 night in shared lodging",
      "Local driver and English-speaking guide",
      "Meals: 3 lunches, drinks during meals",
      "Sleeping bag (if requested)",
      "Airport pickup"
    ],
    exclusion: [
      "Entrance fees (Isla Incahuasi, Eduardo Avaroa National Park)",
      "Toilets on route",
      "Hot springs entry",
    ...
    suggestedPackingList: [
      ...
      "Extra 5 liters of bottled water, snacks, personal medication",
  ...
  },
  {
    ...
    tourInfo:[
      ...
      '<strong className="font-bold">End Point:</strong> 6:30PM  Uyuni, Bolivia',
    ],
    itinerary: [
      {
        title: "Train Graveyard",
        description: "Visit the iconic 'train graveyard' in Uyuni to explore Bolivia's first locomotives and capture unique photos."
      },
      {
        title: "Colchani Village",
        description: "Immerse in the culture of Colchani, a village where local artisans craft salt handicrafts and llama and alpaca textiles."
      },
      {
        title: "Uyuni Salt Flats",
        description: "Traverse the vast, white Uyuni Salt Flats at 3,650 meters. Discover Los Ojos de Agua Salada and visit a hotel made entirely of salt, now a museum."
      },
      {
        title: "Lunch",
        description: "Enjoy a delightful lunch on the salt flats, with complimentary drinks."
      },
      {
        title: "Isla Incahuasi (Fish Island)",
        description: "Hike to the top of Isla Incahuasi to see giant cacti and petrified coral formations. Perfect for creative perspective photos."
      },
      {
        title: "Sunset",
        description: "Witness a mesmerizing sunset over the salt flats to conclude the day."
      }
    ],
    additionalInformation: [
    ...
    highlights: [
      "Pickup from accommodation or bus station",
      "Travel in a 4WD vehicle with rooftop luggage rack",
      "Local driver and English-speaking guide",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Visit the Train Graveyard and Colchani Village",
      "Marvel at giant cacti on Isla Incahuasi",
      "Enjoy a sunset over the salt flats"
    ],
    included: [
      "Round-trip bus transportation between La Paz and Uyuni",
      "Transfers in La Paz and Uyuni",
      "4WD vehicle with English-speaking guide",
      "One lunch with drinks",
      "Entrance fees to Isla Incahuasi"
    ],
    exclusion: [
      "Toiletries (towels, toilet paper, soap)",
      "Additional meals and drinks not specified",
      "Toilets along the way (approx. 10 Bs)",
      "Tips for guide and driver",
      "Personal expenses and travel insurance",
      "2-liter water bottle (recommended to bring)"
    ],
    additionalInformation: [
      {
        "season": "Rainy Season",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Explore Lake Titicaca and mystical Isla del Sol",
      "Experience authentic silver mines in Potosí",
      "Wander through Sucre's colonial UNESCO streets",
      "Visit vibrant markets in La Paz",
      "Photograph flamingo-filled lagoons in the Atacama Desert",
    ],
    included: {
      "accommodation": [
        "Boutique hotels in cities",
        "Unique salt hotel experience in Uyuni",
        "Island homestay at Lake Titicaca"
      ],
      "transportation": [
        "All ground transport between destinations",
        "4x4 vehicles for salt flats expedition",
        "Comfortable tourist-class buses"
      ],
      "meals": [
        "3 Breakfasts",
        "4 Lunches",
        "3 Dinners",
        "Traditional Bolivian cuisine experiences"
      ],
      "guided_experiences": [
        "La Paz city walking tour with local expert",
        "Lake Titicaca & Isla del Sol expedition",
        "Sucre heritage walk",
        "Potosí silver mine adventure",
        "3-day Uyuni Salt Flats journey"
      ]
    },
    itinerary: [
      {
        ...
        "description": "Begin your adventure at Lake Titicaca, exploring Copacabana before sailing to Isla del Sol. Hike Inca trails, visit the Pilcocaina Temple, and enjoy lake sunsets."
      },
      {
        "days": "3-4",
        "title": "La Paz City Encounter",
        "description": "Discover La Paz with panoramic views from the cable car, explore the Witches' Market, and experience local culture in vibrant marketplaces."
      },
      {
        "days": "5-6",
        "title": "Sucre - The White City",
        "description": "Explore Sucre's UNESCO-listed historic center, visit Casa de la Libertad, and enjoy the pleasant climate and colonial architecture."
      },
      {
        "day": 7,
        "title": "Potosí Silver Mines",
        "description": "Descend into the famous Cerro Rico silver mines and learn about Potosí's mining history and significance in colonial South America."
      },
      {
        "days": "8-10",
        "title": "Uyuni Salt Flats Expedition",
        "description": "Experience the 3-day Uyuni Salt Flats journey with visits to the Train Cemetery, Eduardo Avaroa National Reserve, colorful lagoons, geysers, and diverse wildlife."
      }
    ],
    additionalInformation: {
      "best_time_to_visit": "April to October (dry season)",
      "altitude": "Tours reach 4,200m (13,780ft)",
  ...
  },
  {
    ...
    overview: {
      "duration": "7 days",
      "start_location": "La Paz, Bolivia",
      "end_location": "La Paz, Bolivia/San Pedro De Atacama",
      "max_group_size": "12",
    },
    tourInfo: [
      '<strong className="font-bold"> Place Covered</strong>: La Paz-Potosí-Sucre',
    ...
    highlights: [
      ...
      "Capture stunning photos on the Salar de Uyuni salt flats",
      "Stay in unique salt hotels",
      "Spot wild flamingos at colorful highland lagoons",
      "Visit the world's highest desert",
    ],
    included: {
      "accommodation": [
        "1 night in Sucre",
        "1 night in Potosí",
        "1 night in Uyuni",
        "2 nights during Salt Flats expedition (including 1 night in a salt hotel)"
      ],
      "transportation": [
        "All transfers between destinations",
        "4x4 vehicle for Salt Flats tour",
        "Comfortable buses between major cities"
      ],
      "meals": [
        "4 breakfasts",
        "2 lunches",
      ...
      "guided_experiences": [
        "Walking tour of Sucre with local expert",
        "Potosí silver mine exploration",
        "Historic Casa de la Moneda (Mint) visit",
        "3-day Uyuni Salt Flats adventure"
      ]
    },
    exclusion: [
      "Guide throughout the trip",
  ...
  {
    id: 8,
    title: "Highlights of Lake Titicaca",
    overview: {
      "duration": "3 days",
      "start_location": "Copacabana",
      "end_location": "Copacabana/Puno/La Paz"
    },
    tourInfo: [
      '<strong className="font-bold"> Place Covered</strong>: La Paz-Potosí-Sucre',
      ' <strong className="font-bold">Duration:</strong> 12 Days, 11 Nights',
    ...
    included: [
      ...
      "1 Box lunch (water, banana, apple, and chocolate)",
      "1 night in a private room on Sun Island",
      "1 night in a private room in Copacabana",
      "Round-trip motor boat transport",
      "All entrance fees",
    ...
    "why_choose_us": "Our Lake Titicaca tour offers a blend of adventure and cultural immersion, exploring hidden gems and providing unique insights into Bolivian culture. Our flexible itinerary allows you to explore at your own pace.",

  },
  {
    id: 9,
    title: "Titicaca Revealed: 2 Days 1 Night",
    overview: {
      "duration": "2 days",
      "start_location": "La Paz/Copacabana",
      "end_location": "Copacabana/Puno/La Paz"
    },
    tourInfo: [
      '<strong className="font-bold"> Place Covered</strong>: La Paz-Potosí-Sucre',
      ' <strong className="font-bold">Duration:</strong> 2 Days',
      '<strong className="font-bold">Start Point:</strong> La Paz/Copacabana, Bolivia',
      '<strong className="font-bold">End Point:</strong>  Copacabana/Puno/La Paz',
    ],
    itinerary: [
      {
        "day": 1,
  ...
  },
  {
    ...
    tourInfo: [
      '<strong className="font-bold"> Place Covered</strong>: La Paz-Potosí-Sucre',
      ' <strong className="font-bold">Duration:</strong> 1 Days',
      '<strong className="font-bold">Start Point:</strong> Copacabana, Bolivia',
      '<strong className="font-bold">End Point:</strong>  Copacabana, Bolivia',
    ],
    itinerary: [
      {
        "step": 1,
    ...
    inclusions: [
      ...
      "Food (1 lunch)",
      "Box lunch (water, banana, apple, chocolate)",
  ...
  },
  {
    ...
    additionalInformation:{
      "rainy_season_changes": [
        ...
        "On Day 2, visit Sol de Mañana Geyser and hot springs in the afternoon instead of on Day 3."
      ],
      "winter_season_notes": [
        "From June to August, access to Eduardo Avaroa National Park may be limited, so the Black Lagoon and Rock Valley are alternative stops.",
        "Overnight stays may adjust due to road conditions."
      ],
      "weather_warning": "Temperatures can drop below -15°C from May to August, so warm clothes like scarves and wool hats are essential."
    },
    included: [
      "Private round-trip transport",
      "Bilingual specialized guide",
      ...
      "Entrance fees",
      "Overnight stays in Sajama and Jirira"
    ],
    exclusion: [
      "Tips",
      "Extra drinks"
  ...
  },
  {
    ...
    tourInfo: [
      '<strong className="font-bold"> Place Covered</strong>: La Paz-Potosí-Sucre',
      ' <strong className="font-bold">Duration:</strong> 2 days / 1 night',
      '<strong className="font-bold">Start Point:</strong> La Paz, Bolivia',
      '<strong className="font-bold">End Point:</strong>  La Paz, Bolivia',
    ],
    itinerary: [
  ...
  },
  {
    ...
    additionalInformation: {
      "seasonal_adjustments": [
        {
          "season": "Rainy Season (January-April)",
          "adjustments": [
            "Itinerary modifications due to water-filled salt flats.",
            "Alternative stops for sky reflections instead of Inca Wasy Island."
          ]
        },
        {
          "season": "Winter Season (June-August)",
          "adjustments": [
            "Limited access to Eduardo Avaroa National Reserve due to snow.",
            "Possibility to visit alternative sites such as Black Lagoon and Rock Valley."
          ]
        }
      ],
      "packing_essentials": [
    ...
    suggested_packing_list: [
      ...
      "Swimsuit and towel for hot springs",
      "Extra water (5 liters recommended)",
      "Snacks, personal medication",
      "Flashlight/torch, camera, extra batteries and memory card",
      "Charger (electricity available in most hotels)",
      "Hand sanitizer, personal first aid kit",
      "Additional warm clothes for chilly evenings at high altitudes"
    ],
    faqs: [
      {
        "question": "What are the highlights of the Sajama National Park and Uyuni Salt Flats tour?",
        "answer": "The tour includes visits to Sajama National Park, the highest mountain in Bolivia, natural hot springs, and the Uyuni Salt Flats. Key attractions also include Incahuasi Island, the Train Cemetery, and the stunning Andean lagoons."
      },
      {
        "question": "What should I pack for the tour?",
        "answer": "We recommend packing sun protection (hat, sunglasses, sunscreen), warm clothing (coat, gloves, wool hat), trekking shoes, a swimsuit and towel for hot springs, extra water (at least 5 liters), snacks, personal medication, a flashlight, camera with extra batteries and memory card, and a personal first aid kit."
      },
      {
        "question": "How does the itinerary change during different seasons?",
        "answer": "During the rainy season (January to April), water on the salt flats may alter routes; expect more reflective landscapes. In winter (June to August), access to certain areas like Eduardo Avaroa National Park might be restricted due to snow. Adjustments will be made accordingly."
      },
      {
        "question": "Are there any special considerations for altitude?",
        "answer": "Yes, you will be traveling at altitudes up to 4,300 meters above sea level. It's important to stay hydrated and acclimatize properly. Bring warm clothes as temperatures can drop significantly at night."
      },
      {
        "question": "What is included in the tour package?",
...
export const Duration = ["1-3 Days", "3-5 Days", "5-7 Days", "7-10 Day", "10-20"];
